...
USER_ADDRESSES_FOLLOW = '0x6a72f61820b26b1fe4d956e17b6dc2a1ea3033ee'
...
**📖 For detailed setup instructions, see [Getting Started Guide](./docs/入门指南.md)**
...
|----------|-------------|---------|
| `USER_ADDRESSES_FOLLOW` | 跟方向（逗号或 JSON 数组） | `'0xABC...'` |
| `USER_ADDRESSES_REVERSE` | 反买（逗号或 JSON 数组） | `'0xDEF...'` |
...
4. Add wallet addresses to `USER_ADDRESSES_FOLLOW` and/or `USER_ADDRESSES_REVERSE`

**📖 For complete configuration guide, see [Quick Start](./docs/快速开始.md)**

## Documentation

### Getting Started
- **[🚀 Getting Started Guide](./docs/入门指南.md)** - Complete beginner's guide
- **[⚡ Quick Start](./docs/快速开始.md)** - Fast setup for experienced users

## License

MIT License - See [LICENSE](开源许可.md) file for details.
