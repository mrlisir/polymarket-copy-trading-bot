...
- **[Main 项目说明](../项目说明.md)** - Complete documentation
- **[Multi-Trader Guide](./多交易员指南.md)** - Advanced multi-trader setup
- **[Logging Preview](./日志预览.md)** - Console output examples
...
2. Review the [main 项目说明](../项目说明.md)
