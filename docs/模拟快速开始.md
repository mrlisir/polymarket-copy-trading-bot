...
└── docs/
    ├── 模拟运行器指南.md  # Complete guide
    └── 模拟指南.md         # How simulation works
```
...
- **[Complete simulation guide](./模拟运行器指南.md)**
- **[How simulation works](./模拟指南.md)**
- **[Multi-Trader Guide](./多交易员指南.md)**
- **[Quick Start Guide](./快速开始.md)**
